 ...
 * 
 * $Id: EncodeUtils.java,v 1.1 2018/02/06 02:00:54 biewenxiang Exp $
 */
...
public class EncodeUtils extends StringEscapeUtils {
	...
	public static String hexEncode(byte[] input) {
		return Hex.encodeHexString(input).toLowerCase();
	}
	...
	//将json字符串放入map
	public static Map<String, Object> turnMap(String d){
		if(d == null || "".equals(d)){
			return null;
		}
		...
		try {
			...
			Map<String,Object> mm = om.readValue(d, Map.class);
			return mm;
